      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '20px' }}>
          ...
          <div style={{ borderRadius: '6px', backgroundColor: 'white', marginBottom: '50px', border: '2px solid rgba(157,0,255,0.2)' }}>
            <ReactQuill theme="snow" value={formData.model_desc} onChange={(value) => setFormData({ ...formData, model_desc: value })} modules={modules} placeholder="Enter model description..." style={{ minHeight: '380px', fontSize: '16px', color: 'black' }} />
          </div>
        </div>
